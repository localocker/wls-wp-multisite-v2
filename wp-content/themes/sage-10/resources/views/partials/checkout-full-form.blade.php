      ...
      <div class="accordion-item blue">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionCheckout">
          <div class="accordion-body p-3 p-sm-4">
            ...
            @if($checkout_subtitle_text)
            <div class="pb-4">
              {!! $checkout_subtitle_text !!}
            </div>
            @endif

            {{-- Basic Klaviyo Information --}}
            <form>
              <div class="row">
      ...
      <div class="accordion-item blue">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionCheckout">
          <div class="accordion-body p-3 p-sm-4">
            ...
            {{-- Protection Plan & Expected Move In Date --}}
            <form id='formStep2'>
              <div class="row">
...
@endphp
      ...
      {{-- END ACCORDION 2 - Unit Information --}}


      {{-- ACCORDION 3 - Address and Driver's License --}}
      <div class="accordion-item blue">
        <h2 class="accordion-header">
            ...
            <form id="formStep3">
              <div class="row">
                ...
                <div class="col-12 col-md-6 mb-4">
                  ...
                  <p class="text-size-tiny-14"> If you do not have an ID call us at {!! $company_phone !!} to make a booking. </p>
                </div>
      ...
      {{-- END ACCORDION 3 - Address and Driver's License --}}
      ...
      {{-- END ACCORDION 4 - Create Your Account --}}
                        ...
                        <form id="formStep5ACH">
                          ...
                          <div class="payment-options ach col-12">
                            <div class="row">
                              ...
                              {{-- ACH Alternate Address - SCRIPT TO HIDE IF CHECKED IS AND THE END OF THIS --}}
                              <div class="col-12 mb-4">
      ...
      {{-- END ACCORDION 6 - Esign --}}

      {{-- component with response from API call --}}
      <div id="responseComponent" class="mt-4"></div>
      {{-- component with response from API call END --}}
