{{-- Sitwide and Homepage Specific Custom Fields --}}
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-8 col-xxl-9">
      <div class="filtered-items pb-1" id="filtered-items">
        ...
        @while ($unitquery->have_posts()) @php $unitquery->the_post() @endphp
          ...
          <div class="filtered-item" data-unit-id="<?php echo esc_attr($unit_id); ?>">
            ...
            <div class="filter-item-image-container position-relative overflow-hidden">
              <button class="button is-icon is-smaller-light w-inline-block size-link" @if($size_help) data-bs-toggle="modal" data-bs-target="#sizeModal" @endif>
                ...
                <div>
                  @if($size && in_array('small', $size))
                    Small
                  @elseif($size && in_array('medium', $size))
                    Medium
                  @elseif($size && in_array('large', $size))
                    Large
                  @endif
                </div>
              </button>
              ...
              @if (has_post_thumbnail())
                <a href="{!! $unit_featured_img !!}" title="@if($dimensions_of_unit) {!! $dimensions_of_unit !!} @endif" class="venobox w-100 h-100" data-gall="Units">
            ...
            {{-- Thumbnail and size End --}}


            <div class="filtered-item-details-container py-0">

              {{-- Dimensions, Unit Type, Size Help --}}
              ...
              {{-- Dimensions, Unit Type, Size Help END --}}


              {{-- Promo Text, hidden until XXL size --}}
                ...
                <div class="filter-item-detail right-flex-end-justified">
                  ...
                  @if($available_units_count > 0)
                    <div class="reserve-now">
                      <a href="{!! get_blog_details()->path !!}checkout/full-form/?unit_id={!! $unit_id !!}" class="button is-blue is-icon is-smaller mt-0 mt-sm-1 mt-xxl-0 w-inline-block">
                        <div>Reserve Now</div>
                      </a>
                    </div>
                  @else
        ...
        {{-- Standard Wordpress: the_content --}}

          <?php the_content(); ?>

        {{-- Standard Wordpress: the_content end --}}
