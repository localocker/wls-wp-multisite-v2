      ...
      ?>
        ...
        @endif
          ...
          <div class="col-12 col-lg-6 about-block-details d-flex align-items-center">
            <div class="w-100 @if( get_row_index() % 2 == 0 ) pe-lg-3 pe-xl-4 @else ps-lg-3 ps-xl-4 @endif">
              ...
              @if($block_options)
                <div class="attributes-wrap d-flex justify-content-start flex-wrap">
                  ...
                  @if($block_options && in_array('gated', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="<?php echo $secondary_color; ?>" xmlns="http://www.w3.org/2000/svg">
                  ...
                  @if($block_options && in_array('247booking', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('aircon', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('lighting', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="<?php echo $secondary_color; ?>" xmlns="http://www.w3.org/2000/svg">
                  ...
                  @if($block_options && in_array('monthlease', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('contactless', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('keypad', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                        <svg width="24" height="24" viewbox="0 0 16 16" fill="<?php echo $secondary_color; ?>" stroke="" xmlns="http://www.w3.org/2000/svg">
                  ...
                  @if($block_options && in_array('business', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                        <svg width="24" height="24" viewbox="0 0 16 16" fill="<?php echo $secondary_color; ?>" stroke="" xmlns="http://www.w3.org/2000/svg">
                  ...
                  @if($block_options && in_array('covered', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('uncovered', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('humidity', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('stacked', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('24hour', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('alarm', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('climate', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('driveup', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('power', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('1stfloor', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('rvstorage', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('boatstorage', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('vehiclestorage', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('parking', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
                  ...
                  @if($block_options && in_array('ev', $block_options))
                    <div class="attribute-item d-flex align-items-center">
                      <div class="standard-svg-icon w-embed">
