...
<section class="container hero-wrapper">
  <div class="row d-flex align-items-stretch">
    ...
    <div class="col-12 col-lg-6 hero-block">
      ...
      {{-- Google Reviews --}}
      @if($google_review_badge)
        @unless($hide_google_review_badge)
      ...
      <div class="hero-info-wrapper w-full mb-4 pb-3">
        <div class="hero-address d-flex align-items-center font-weight-700 w-full gap-2">
          ...
          @if($address)
            @if($google_map_link)
              <a href="{!! $google_map_link !!}" title="Property Google Map" target="_blank" class="d-flex align-items-center underline secondary-color">
            @else
      ...
      <div class="hero-info-wrapper w-full d-flex flex-wrap flex-sm-nowrap justify-content-start align-items-start mb-4 pb-3">
        ...
        <div class="w-100">
          ...
          @if($access_hours_details)
            <div class="">
              {!! $access_hours_details !!}
            </div>
          @endif
              ...
              <?php if( have_rows('access_hours') ): ?>
                ...
                ?>
                  ...
                  <div class="text-size-small-16">
                    <strong class="blue montserrat font-weight-700">{!! $hours_title !!}</strong> {!! $hours_time !!}
                  </div>
        ...
        <div class="w-100">
          ...
          @if($support_hours_details)
            <div class="">
              {!! $support_hours_details !!}
            </div>
          @endif
      ...
      <div class="hero-features border-radius-8px d-flex justify-content-around justify-content-sm-center align-items-stretch flex-wrap w-100 p-3">
        ...
        @if($amenities_features && in_array('gated', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
              <svg width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="<?php echo $secondary_color; ?>" xmlns="http://www.w3.org/2000/svg">
        ...
        @if($amenities_features && in_array('247booking', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('aircon', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('lighting', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
              <svg width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="<?php echo $secondary_color; ?>" xmlns="http://www.w3.org/2000/svg">
        ...
        @if($amenities_features && in_array('monthlease', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('contactless', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('keypad', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
              <svg width="24" height="24" viewbox="0 0 16 16" fill="<?php echo $secondary_color; ?>" stroke="" xmlns="http://www.w3.org/2000/svg">
        ...
        @if($amenities_features && in_array('business', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="<?php echo $secondary_color; ?>" stroke="none" fill="currentColor" class="bi bi-snow" viewBox="0 0 16 16">
                <path d="M8 16a.5.5 0 0 1-.5-.5v-1.293l-.646.647a.5.5 0 0 1-.707-.708L7.5 12.793V8.866l-3.4 1.963-.496 1.85a.5.5 0 1 1-.966-.26l.237-.882-1.12.646a.5.5 0 0 1-.5-.866l1.12-.646-.884-.237a.5.5 0 1 1 .26-.966l1.848.495L7 8 3.6 6.037l-1.85.495a.5.5 0 0 1-.258-.966l.883-.237-1.12-.646a.5.5 0 1 1 .5-.866l1.12.646-.237-.883a.5.5 0 1 1 .966-.258l.495 1.849L7.5 7.134V3.207L6.147 1.854a.5.5 0 1 1 .707-.708l.646.647V.5a.5.5 0 1 1 1 0v1.293l.647-.647a.5.5 0 1 1 .707.708L8.5 3.207v3.927l3.4-1.963.496-1.85a.5.5 0 1 1 .966.26l-.236.882 1.12-.646a.5.5 0 0 1 .5.866l-1.12.646.883.237a.5.5 0 1 1-.26.966l-1.848-.495L9 8l3.4 1.963 1.849-.495a.5.5 0 0 1 .259.966l-.883.237 1.12.646a.5.5 0 0 1-.5.866l-1.12-.646.236.883a.5.5 0 1 1-.966.258l-.495-1.849-3.4-1.963v3.927l1.353 1.353a.5.5 0 0 1-.707.708l-.647-.647V15.5a.5.5 0 0 1-.5.5z"/>
        ...
        @if($amenities_features && in_array('covered', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('uncovered', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('humidity', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('stacked', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('24hour', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('alarm', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('climate', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('driveup', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('power', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('1stfloor', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('rvstorage', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('boatstorage', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('vehiclestorage', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('parking', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
        ...
        @if($amenities_features && in_array('ev', $amenities_features))
          <div class="hero-features-item d-flex align-items-center justify-content-center flex-wrap">
            <div class="standard-svg-icon w-embed">
    ...
    {{-- Right Side Image Carousel - Location Photo & Google Map --}}
        ...
        <div class="carousel-inner h-100">
          @if($location_photo)
            <div class="carousel-item h-100 active">
              {!! wp_get_attachment_image( $location_photo, $hero_size, "", ["class" => "hero-image"] ); !!}
            </div>
          @endif

          @if($google_map_hero)
            <div class="carousel-item h-100">
              {!! wp_get_attachment_image( $google_map_hero, $hero_size, "", ["class" => "hero-image"] ); !!}
              <div class="carousel-caption">

                @if($address)
                  <h5 class="font-weight-600 background-white p-2 border-radius-8px border-light-gray">
                    @if($google_map_link)
                      <a href="{!! $google_map_link !!}" title="Location - Google Map" target="_blank" class="">
                    @endif
                      {!! $address !!}
                    @if($google_map_link)
                      </a>
    ...
    {{-- End Right Side Image Carousel - Location Photo & Google Map --}}

  </div>
</section>
{{-- End Hero Wrapper Row --}}
