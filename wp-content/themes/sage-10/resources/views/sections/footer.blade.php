          ...
          <div class="row">
              ...
              <div class="footer-contact-wrap">
                ...
                <div class="footer-contact-item d-flex align-items-center justify-content-start">
                  ...
                  <div class="text-size-small-16">
                    @if($footer_phone)
                      <strong class="white">Call/Text:</strong> {!! $footer_phone !!}
                    @endif
                  </div>
                </div>
            ...
            <div class="col-12 col-sm-6 footer-logo-wrap d-flex flex-wrap align-items-center justify-content-start justify-content-lg-end gap-2 gap-sm-1">
              ...
              <div class="footer-links w-100 text-size-tiny-14 text-lg-end">
                &copy;<?php echo date('Y'); ?> {{ get_bloginfo('name', 'display') }} - <a href="{!! get_blog_details()->path !!}privacy-policy" title="Privacy Policy" class="white-link-hover">Privacy Policy</a> - <a href="{!! get_blog_details()->path !!}terms" title="Terms & Conditions" class="white-link-hover">Terms</a>
              </div>
            </div>
            {{-- Right End --}}
