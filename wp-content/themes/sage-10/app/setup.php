...
add_action('after_setup_theme', function () {
    ...
    add_image_size( 'adminsize', 400, 9999 );
...
// Scrollbar JS
// wp_enqueue_script( 'sage-10', get_stylesheet_directory_uri() . '/resources/scripts/jquery.scrollbar.min.js', array( 'jquery', 'scrollbar' ) );
...
// Remove "Archives" from CPT Archive title - also done in page-header as an echo with Archives removed
...
/*-----------------------------------------------------------------------------------*/
/* ADD Unit Custom Fields in Admin Column for STORAGE UNIT Post Type
/*-----------------------------------------------------------------------------------*/
...
if ( $column_name == 'dimensions' ) {
  // Display an ACF field
  echo get_field( 'dimensions_of_unit', $post_id );
}

if ( $column_name == 'unit_type' ) {
  // Display an ACF field
  echo get_field( 'unit_type', $post_id );
}
