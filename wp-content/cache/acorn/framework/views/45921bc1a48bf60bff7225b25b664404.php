...
<section class="mt-0 pt-0 background-white" id="site-header">
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <header class="banner d-flex justify-content-end align-items-center">
          ...
          <div class="nav-menu-wrap me-3 d-none d-md-block">
          ...
          <?php if($pay_your_bill_title): ?>
            <a href="<?php echo $bill_payment_link; ?>" class="button is-icon is-white-shadowed is-small w-inline-block" target="_blank">
          <?php else: ?>
      ...
      <div class="col-12 d-md-none py-2 mt-1 text-size-tiny-14 text-center white" style="background-color: <?php echo $secondary_color; ?>">
        <?php if($call_or_text_title && $header_phone_number): ?>
          <?php echo $call_or_text_title; ?> <span class="font-weight-700"><?php echo $header_phone_number; ?></span>
        <?php endif; ?>
      </div>
    </div>
  </div>
</section>
<?php /**PATH /Users/bengross/Local Sites/white-label-storage-b2c/app/public/wp-content/themes/sage-10/resources/views/sections/header.blade.php ENDPATH**/ ?>