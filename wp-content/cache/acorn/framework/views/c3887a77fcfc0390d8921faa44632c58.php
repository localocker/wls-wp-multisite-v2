...
<footer class="content-info footer" style="background-color: <?php echo $main_color; ?>">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 mb-4 mb-sm-0">
              ...
              <div class="footer-contact-wrap">
                ...
                <div class="footer-contact-item d-flex align-items-center justify-content-start">
                  ...
                  <div class="text-size-small-16">
                    <?php if($footer_phone): ?>
                      <strong class="white">Call/Text:</strong> <?php echo $footer_phone; ?>
            ...
            <div class="col-12 col-sm-6 footer-logo-wrap d-flex flex-wrap align-items-center justify-content-start justify-content-lg-end gap-2 gap-sm-1">
              <?php if($footer_logo): ?>
                <?php echo wp_get_attachment_image( $footer_logo, $footer_logo_size, "", ["class" => "footer-logo mb-4"] ); ?>
              <?php endif; ?>

              <?php if($footer_legal_line): ?>
                <h6 class="powered-by w-100 mb-2 white text-size-tiny-15 font-weight-600 text-lg-end">
                  Powered By
                  <a href="https://www.whitelabelstorage.com/" title="White Label Storage" target="_blank" class="white-link-hover underline">
              ...
              <div class="footer-links w-100 text-size-tiny-14 text-lg-end">
                &copy;<?php echo date('Y'); ?> <?php echo e(get_bloginfo('name', 'display')); ?> - <a href="<?php echo get_blog_details()->path; ?>privacy-policy" title="Privacy Policy" class="white-link-hover">Privacy Policy</a> - <a href="<?php echo get_blog_details()->path; ?>terms" title="Terms & Conditions" class="white-link-hover">Terms</a>
              </div>
            </div>
...
<?php /**PATH /Users/bengross/Local Sites/white-label-storage-b2c/app/public/wp-content/themes/sage-10/resources/views/sections/footer.blade.php ENDPATH**/ ?>