...
class Assets extends Controller {
	...
	private function register_general_scripts() {
		...
		$footer_text = \SmartCrawl\Controllers\White_Label::get()->get_wpmudev_footer_text( sprintf( esc_html__( 'Made with %s by WPMU DEV', 'wds' ), '<span class="sui-icon-heart" aria-hidden="true" aria-label="love"></span>' ) );
