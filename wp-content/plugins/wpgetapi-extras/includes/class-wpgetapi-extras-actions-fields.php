...
class WpGetApi_Extras_Actions_Fields {
	...
	public function actions_field( $endpoint_fields ) {
		...
		if ( isset( $_GET['page'] ) && strpos( $_GET['page'], 'wpgetapi_' ) !== false ) {
			...
			$conditionals[] = array(
				'name'              => __( 'Post Type', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Choose the post type to use for this action.', 'wpgetapi' ) . '"></span>',
				'id'                => 'post_type',
				'type'              => 'multicheck',
			...
			$conditionals[] = array(
				'name'              => __( 'Old Post Status', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Run this action only when the post transitions from this status.', 'wpgetapi' ) . '"></span>',
				'id'                => 'old_post_status',
				'type'              => 'multicheck',
				'select_all_button' => false,
			...
			$conditionals[] = array(
				'name'              => __( 'New Post Status', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Run this action only when the post transitions to this new status.', 'wpgetapi' ) . '"></span>',
				'id'                => 'new_post_status',
				'type'              => 'multicheck',
				'select_all_button' => false,
			...
			if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
				$conditionals[] = array(
					'name'              => __( 'Old Order Status', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Run this action only when the order transitions from this status.', 'wpgetapi' ) . '"></span>',
					'id'                => 'old_order_status',
					'type'              => 'multicheck',
					'select_all_button' => false,
					'classes'           => 'field-old-status',
				...
				$conditionals[] = array(
					'name'              => __( 'New Order Status', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Run this action only when the order transitions to this new status.', 'wpgetapi' ) . '"></span>',
					'id'                => 'new_order_status',
					'type'              => 'multicheck',
					'select_all_button' => false,
					'classes'           => 'field-new-status',
			...
			if ( is_plugin_active( 'elementor-pro/elementor-pro.php' ) ) {
				$conditionals[] = array(
					'name'       => __( 'Elementor Form Name', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The exact name of the form you want to use for this endpoint. You should ensure your form name is unique.', 'wpgetapi' ) . '"></span>',
			...
			if ( is_plugin_active( 'gravityforms/gravityforms.php' ) ||
				 ...
				 */
				$conditionals[] = array(
					'name'    => __( 'Validation', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'If validating, the API is called before the form is submitted allowing you to send or not send the form based on API response.', 'wpgetapi' ) . '"></span>',
					'id'      => 'forms_validation',
					'type'    => 'select',
					'default' => 'after',
					'options' => array(
				...
				$conditionals[] = array(
					'name'    => __( 'Type of validation', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Choose how to validate the form submission.', 'wpgetapi' ) . '"></span>',
					'id'      => 'forms_validation_type',
					'type'    => 'select',
					'default' => 'send_if_200',
					'options' => array(
						'send_if_200'               => 'Only submit form if API response code is 200',
				...
				$conditionals[] = array(
					'name'       => __( 'Value', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The value that you are looking for within the API response. It can be a certain key or a certain value within the response.', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'    => __( 'Error Message', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The validation error message to display to the user.', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'    => __( 'Error Field ID', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The field ID that you want to display the error message on.', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'    => __( 'Display', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'What do we want to display to the user, or it can be a redirect.', 'wpgetapi' ) . '"></span>',
					'id'      => 'forms_display',
					'type'    => 'select',
				...
				$conditionals[] = array(
					'name'       => __( 'Key', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'If the API response you need is within an array, you can step down into the array and select a key to get the corresponding value you need. Works the same way as Nested Data but only supports getting single value from a single key.<br><a href=\'https://wpgetapi.com/docs/retrieve-nested-data/\' target=\'_blank\'>More Info</a>', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'       => __( 'Success URL', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The URL to go to, based on the success value from the API.', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'       => __( 'Success Value', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The key or value to look for in the API when it is a successful API call.', 'wpgetapi' ) . '"></span>',
				...
				$conditionals[] = array(
					'name'       => __( 'Error URL', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The URL to go to, based on the error value from the API.', 'wpgetapi' ) . '"></span>',
					'id'         => 'forms_error_url',
					'type'       => 'text',
				...
				$conditionals[] = array(
					'name'       => __( 'Error Value', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The key or value to look for in the API when it is a non-successful API call.', 'wpgetapi' ) . '"></span>',
	...
	public function get_action_field() {
		...
		$field = array(
			array(
				'name'    => __( 'Actions', 'wpgetapi-extras' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Call this endpoint when your chosen action runs.', 'wpgetapi' ) . '"></span>',
				'id'      => 'actions',
				'type'    => 'select',
